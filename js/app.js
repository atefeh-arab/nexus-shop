...
(function () {
  ...
  const ICONS = {
    ...
    gear: '<svg width="__S__" height="__S__" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M10.6 3.2h2.8l.42 2.14a6.9 6.9 0 0 1 1.9.79l1.83-1.2 1.98 1.98-1.2 1.83c.35.58.62 1.22.8 1.9l2.13.41v2.8l-2.14.42a6.9 6.9 0 0 1-.79 1.9l1.2 1.83-1.98 1.98-1.83-1.2a6.9 6.9 0 0 1-1.9.8l-.42 2.12h-2.8l-.41-2.13a6.9 6.9 0 0 1-1.9-.79l-1.83 1.2-1.98-1.98 1.2-1.83a6.9 6.9 0 0 1-.8-1.9L3.2 13.4v-2.8l2.14-.42c.18-.67.44-1.31.79-1.9l-1.2-1.83 1.98-1.98 1.83 1.2a6.9 6.9 0 0 1 1.9-.8z"/><circle cx="12" cy="12" r="2.7"/></svg>',
    users:'<svg width="__S__" height="__S__" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8.4" r="3.3"/><path d="M2.7 19.6c1-3.1 3.5-4.8 6.3-4.8s5.3 1.7 6.3 4.8"/><path d="M15.4 5.5a3.3 3.3 0 0 1 0 5.9M17.7 15.1c1.8.75 3.1 2.2 3.7 4.4"/></svg>',
    search:'<svg width="__S__" height="__S__" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><circle cx="11" cy="11" r="7"/><path d="M20.5 20.5 16 16"/></svg>',
  };
